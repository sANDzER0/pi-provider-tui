 ...
 */
export function isReferenceValue(value: string | undefined): boolean {
  if (!value) return false;
  if (value.startsWith("!")) return true; // command (note: "$!" is not "!")
...
export async function resolveValue(
  value: string,
  opts: RunCommandOptions & { env?: Record<string, string | undefined> } = {},
